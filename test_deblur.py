...
from dataloaders.data_rgb import get_test_data,get_test_images
import utils
...
parser.add_argument('--save_model_name', default='0', type=str, help='save_model_name')
...
with torch.no_grad():
    ...
    for ii, data_test in enumerate(tqdm(test_loader), 0):
        ...
        save_pic_name = os.path.join('result', args.save_model_name, filenames[0].split('/')[-3])
